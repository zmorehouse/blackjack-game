                ...
                <div className="slidingDivs">
                    ...
                    >
                        <div className="slidercontainer">
                            ...
                            <div className="description"><p> First time playing? Learn the basics of Blackjack.
                                
                            </p></div>
                            </div>
                            <div className="title"><h2>Blackjack Basics
                            </h2></div>
                        </div>
                    </motion.div>
        ...
        <div className="slidercontainer">
            ...
            <div className="title"><h2>Practice Tool</h2></div>
                    ...
                    >
                        ...
                        <div>
                            <div className="comingsoon"> <p> Coming Soon </p></div>
                            <div className="description"><p>Learn and master optimal Blackjack strategy.
                                
                            </p></div>
                            </div>
                            <div className="title"><h2>Optimal Strategy
                            </h2></div>
                        </div>
